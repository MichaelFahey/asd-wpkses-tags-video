=== ASD wpkses tags video ===
Contributors: michaelfahey
Tags: wp_kses, allowedtags, video
Requires PHP: 5.6
...
=== Description ===
This plugin configures WordPress sanitizing functions such as wp_kses to allow the video tag, and the attributes src, class, id, preload, controls, and type for the video tag. It does not affect any other allowed/disallowed tags or attributes.
